...
const replacements = {
    ...
    'text-green-500': 'text-cyber-success',
    'bg-red-900\/50 border-red-900': 'bg-cyber-danger/30 border-cyber-danger',
    'text-red-500 hover:bg-red-900': 'text-cyber-danger hover:bg-cyber-danger hover:text-white',
    'border-red-900\/50': 'border-cyber-danger/50'
};
...
walkDir('./src', function (filePath) {
    if (filePath.endsWith('.jsx')) {
        ...
        // Cleanup specific case to prevent empty class artifacts
        content = content.replace(/btn-cyber btn-cyber-secondary  mt-4/g, 'btn-cyber btn-cyber-primary mt-4');
