    ...
    return (
        <>
            <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-[200] backdrop-blur-sm transform-gpu" onClick={() => handleSave()}>
                <div ref={modalRef} className="card-cyber text-white max-w-3xl w-full max-h-[90vh] flex flex-col p-1 overflow-hidden border-cyber-primary shadow-cyber-primary relative animate-in fade-in zoom-in duration-300" onClick={(e) => e.stopPropagation()}>
